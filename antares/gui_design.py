...
class DragonFrame(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Project Dragon GUI v1211", pos=wx.DefaultPosition,
                          size=wx.Size(1500, 800), style=wx.CAPTION | wx.CLOSE_BOX | wx.MINIMIZE_BOX | wx.TAB_TRAVERSAL)
        ...
        self.rdbxCalculationType = wx.RadioBox(self.pnlOneclick, wx.ID_ANY, u"Data Type", wx.DefaultPosition,
                                               wx.Size(150, 55), rdbxCalculationTypeChoices, 1, wx.RA_SPECIFY_ROWS)
        ...
        self.txtMaterialCode = wx.TextCtrl(self.pnlOneclick, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition,
                                           wx.Size(150, 45), wx.TE_MULTILINE)
        ...
        self.m_staticText2 = wx.StaticText(self.pnlOneclick, wx.ID_ANY, u"Code / H5 Name: ", wx.DefaultPosition,
                                           wx.Size(-1, 15), wx.ALIGN_CENTER_HORIZONTAL)
        ...
        self.lstbxCodeSelection = wx.ListBox(self.pnlOneclick, wx.ID_ANY, wx.DefaultPosition, wx.Size(300, 65),
                                             lstbxCodeSelectionChoices, wx.LB_NEEDED_SB | wx.LB_SINGLE)
        ...
        self.dtpkDate = wx.adv.DatePickerCtrl(self.pnlOneclick, wx.ID_ANY, wx.DefaultDateTime, wx.Point(0, 0),
                                              wx.Size(110, 30), wx.adv.DP_DROPDOWN | wx.BORDER_SUNKEN)
        ...
        self.btnCodeSubmit = wx.BitmapButton(self.pnlOneclick, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition,
                                             wx.DefaultSize, wx.BU_AUTODRAW | wx.BORDER_NONE)
        ...
        self.btnReset = wx.BitmapButton(self.pnlOneclick, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize,
        ...
        self.m_staticline1 = wx.StaticLine(self.pnlOneclick, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                           wx.LI_HORIZONTAL)
        ...
        self.btnInventoryExport = wx.BitmapButton(self.pnlOneclick, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition,
                                                  wx.DefaultSize, wx.BU_AUTODRAW | wx.BORDER_NONE)
        ...
        self.btnBackorderExport = wx.BitmapButton(self.pnlOneclick, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition,
                                                  wx.DefaultSize, wx.BU_AUTODRAW | wx.BORDER_NONE)
        ...
        self.m_staticline6 = wx.StaticLine(self.pnlOneclick, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                           wx.LI_VERTICAL)
        self.m_staticline6.SetFont(
        ...
        self.txtLog = wx.TextCtrl(self.pnlOneclick, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(600, -1),
                                  wx.TE_CENTER | wx.TE_READONLY | wx.BORDER_SUNKEN)
        ...
        self.btnOutputDownload = wx.BitmapButton(self.pnlOneclick, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition,
                                                 wx.DefaultSize, wx.BU_AUTODRAW | wx.BORDER_NONE)
        ...
        self.m_staticline2 = wx.StaticLine(self.pnlOneclick, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                           wx.LI_HORIZONTAL)
        ...
        # self.m_html_chart = wx.html.HtmlWindow(self.pnlOneclick, wx.ID_ANY, wx.DefaultPosition, wx.Size(850, 450),
        #                                        wx.html.HW_SCROLLBAR_AUTO)
        self.m_html_chart = wx.html2.WebView.New(self.pnlOneclick)
        bSizer7.Add(self.m_html_chart, 1, wx.ALL | wx.EXPAND, 3)
        ...
        self.listCtrlOutput = wx.ListCtrl(self.pnlOneclick, wx.ID_ANY, wx.DefaultPosition, wx.Size(600, -1),
        ...
        self.m_DataSync = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool",
                                                       wx.Bitmap(u".icon/sync_icon.png", wx.BITMAP_TYPE_ANY),
                                                       wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString,
                                                       None)

        self.m_toolBar1.AddSeparator()

        self.mDisplayCurrentInventory = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool",
                                                                     wx.Bitmap(u".icon/current_day.png",
                                                                               wx.BITMAP_TYPE_ANY), wx.NullBitmap,
                                                                     wx.ITEM_NORMAL, u"Display current inventory",
                                                                     wx.EmptyString, None)

        self.mCurrentBackorder = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool",
                                                              wx.Bitmap(u".icon/backorder.png", wx.BITMAP_TYPE_ANY),
                                                              wx.NullBitmap, wx.ITEM_NORMAL,
                                                              u"Display current backorder", wx.EmptyString, None)

        self.mBackorderTrend = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool",
                                                            wx.Bitmap(u".icon/bo_trend.png", wx.BITMAP_TYPE_ANY),
                                                            wx.NullBitmap, wx.ITEM_NORMAL,
                                                            u"display trend of backorder value", wx.EmptyString, None)

        self.mAgingBackorder = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool",
                                                            wx.Bitmap(u".icon/aging_backorder.png", wx.BITMAP_TYPE_ANY),
                                                            wx.NullBitmap, wx.ITEM_NORMAL, u"display aging backorder",
                                                            wx.EmptyString, None)

        self.m_toolBar1.AddSeparator()

        self.mPendingInventory = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool",
                                                              wx.Bitmap(u".icon/pending.png", wx.BITMAP_TYPE_ANY),
                                                              wx.NullBitmap, wx.ITEM_NORMAL,
                                                              u"Display trend for pending inventory value",
                                                              wx.EmptyString, None)

        self.mLowABInventory = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool",
                                                            wx.Bitmap(u".icon/low_inventory.png", wx.BITMAP_TYPE_ANY),
                                                            wx.NullBitmap, wx.ITEM_NORMAL,
                                                            u"Display low inventory for Rank A, B products",
                                                            wx.EmptyString, None)

        self.m_toolBar1.AddSeparator()

        self.mInvTrend = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool",
                                                      wx.Bitmap(u".icon/inventory_trend.png", wx.BITMAP_TYPE_ANY),
                                                      wx.NullBitmap, wx.ITEM_NORMAL,
                                                      u"Display inventory trend with selected name", wx.EmptyString,
                                                      None)
        ...
        self.mTU = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool", wx.Bitmap(u".icon/bu_TU.png", wx.BITMAP_TYPE_ANY),
                                                wx.NullBitmap, wx.ITEM_RADIO, u"Trauma", wx.EmptyString, None)

        self.mCMFT = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool",
                                                  wx.Bitmap(u".icon/bu_CMFT.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap,
                                                  wx.ITEM_RADIO, u"CMFT", wx.EmptyString, None)

        self.mPT = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool", wx.Bitmap(u".icon/bu_PT.png", wx.BITMAP_TYPE_ANY),
                                                wx.NullBitmap, wx.ITEM_RADIO, u"PowerTool", wx.EmptyString, None)

        self.mJT = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool", wx.Bitmap(u".icon/bu_JT.png", wx.BITMAP_TYPE_ANY),
                                                wx.NullBitmap, wx.ITEM_RADIO, u"Joint", wx.EmptyString, None)

        self.mSpine = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool",
                                                   wx.Bitmap(u".icon/bu_Spine.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap,
                                                   wx.ITEM_RADIO, u"Spine", wx.EmptyString, None)

        self.mMT = self.m_toolBar1.AddLabelTool(wx.ID_ANY, u"tool", wx.Bitmap(u".icon/bu_MT.png", wx.BITMAP_TYPE_ANY),
                                                wx.NullBitmap, wx.ITEM_RADIO, u"Mitek", wx.EmptyString, None)
...
class dlgAbout(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"About", pos=wx.DefaultPosition, size=wx.Size(400, 260),
        ...
        self.bitmapLogo = wx.StaticBitmap(self, wx.ID_ANY, wx.Bitmap(u".icon/logo.png", wx.BITMAP_TYPE_ANY),
                                          wx.DefaultPosition, wx.Size(-1, -1), 0)
        bSizer14.Add(self.bitmapLogo, 0, wx.ALL, 5)

        bSizer15 = wx.BoxSizer(wx.VERTICAL)

        self.txtCtrlAbout = wx.TextCtrl(self, wx.ID_ANY,
                                        u"The program is GUI only for Project Dragon, to collect and centralize data from oneclick and display historical business information.",
                                        wx.DefaultPosition, wx.Size(200, 120),
