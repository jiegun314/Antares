...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		rdbxBusinessUnitChoices = [ u"JOINT", u"SPINE", u"TRUAMA", u"MITEK", u"CMFT", u"PT" ]
		...
		self.rdbxBusinessUnit.SetSelection( 0 )
		...
		bSizer5.Add( ( 10, 20), 1, wx.EXPAND, 5 )
		...
		self.dtpkDate = wx.adv.DatePickerCtrl( self.pnlOneclick, wx.ID_ANY, wx.DefaultDateTime, wx.Point( 0,0 ), wx.Size( 90,20 ), wx.adv.DP_DEFAULT )
		...
		self.txtLog = wx.TextCtrl( self.pnlOneclick, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 600,-1 ), wx.TE_READONLY|wx.BORDER_SUNKEN )
